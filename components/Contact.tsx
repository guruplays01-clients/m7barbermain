        ...
        <div>
          ...
          <div className="space-y-8 mb-12">
            <div className="flex items-start space-x-6">
              <div className="p-4 gold-bg rounded-xl">
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <a href={`tel:${CONTACT_INFO.phone}`} className="text-[#D4AF37] hover:underline text-lg font-medium">
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                {CONTACT_INFO.hours.map((h, i) => (
                  <div key={i} className="flex justify-between w-64 text-neutral-400 mb-1">
                    <span>{h.day}</span>
                    <span>{h.time}</span>
                  </div>
                ))}
          ...
          <div className="h-[300px] w-full rounded-2xl overflow-hidden shadow-2xl grayscale hover:grayscale-0 transition-all duration-500">
             <iframe 
        ...
        <div className="bg-black border border-neutral-800 p-10 rounded-3xl shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input 
                  type="text" 
                  required
                  className="w-full bg-neutral-900 border border-neutral-800 rounded-xl px-4 py-4 focus:outline-none focus:border-[#D4AF37] transition-colors" 
            ...
            <div>
              ...
              <select className="w-full bg-neutral-900 border border-neutral-800 rounded-xl px-4 py-4 focus:outline-none focus:border-[#D4AF37] transition-colors">
            ...
            <button 
              type="submit" 
              className="w-full gold-bg text-black font-bold py-5 rounded-xl flex items-center justify-center space-x-2 hover:scale-[1.02] transition-transform active:scale-95"
            >
